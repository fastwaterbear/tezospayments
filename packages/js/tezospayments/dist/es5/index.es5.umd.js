(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  function assertContractValid(contract, ctx) {
    ...
    var assertSection = function assertSection(parameter, storage, ret, code) {
      ...
      var out = functionTypeInternal(code, [arg], _assign(_assign({}, ctx), {
        contract: contract
      }));
  ...
  */
  ...
  _defineProperty(EllipticCurveKeyGenerator, "curveInfo", {
    secp256k1: {
      name: 'secp256k1',
  ...
  var Base64PaymentUrlFactory = /*#__PURE__*/function (_PaymentUrlFactory) {
    ...
    _createClass(Base64PaymentUrlFactory, [{
      ...
      value: function createPaymentUrlInternal(payment, network) {
        ...
        try {
          var url = new index.URL(this.baseUrl);
      ...
      value: function createDonationUrlInternal(donation, network) {
        ...
        try {
          var url = new index.URL("".concat(donation.targetAddress, "/donation"), this.baseUrl);
  ...
  _defineProperty$1(TezosPaymentsOptionsValidator, "errors", {
  ...
  var TezosPayments = /*#__PURE__*/function () {
    function TezosPayments(options) {
      ...
      _defineProperty$1(this, "optionsValidator", new TezosPaymentsOptionsValidator());
