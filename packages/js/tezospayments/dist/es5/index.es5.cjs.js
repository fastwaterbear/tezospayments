...
var TezosPaymentsError = /*#__PURE__*/function (_Error) {
  ...
  return _createClass__default["default"](TezosPaymentsError);
...
var InvalidPaymentCreateParametersError = /*#__PURE__*/function (_TezosPaymentsError2) {
  ...
  return _createClass__default["default"](InvalidPaymentCreateParametersError);
}(TezosPaymentsError);
...
var UnsupportedPaymentUrlTypeError = /*#__PURE__*/function (_TezosPaymentsError4) {
  ...
  return _createClass__default["default"](UnsupportedPaymentUrlTypeError);
}(TezosPaymentsError);
var PaymentUrlError = /*#__PURE__*/function (_TezosPaymentsError5) {
  ...
  return _createClass__default["default"](PaymentUrlError);
}(TezosPaymentsError);
var DonationUrlError = /*#__PURE__*/function (_TezosPaymentsError6) {
  ...
  return _createClass__default["default"](DonationUrlError);
}(TezosPaymentsError);
...
var PaymentUrlFactory = /*#__PURE__*/_createClass__default["default"](function PaymentUrlFactory(urlType) {
...
var Base64PaymentUrlFactory = /*#__PURE__*/function (_PaymentUrlFactory) {
  ...
  _createClass__default["default"](Base64PaymentUrlFactory, [{
    ...
    value: function createPaymentUrlInternal(payment, network) {
      ...
      try {
        var url = new common.native.URL(this.baseUrl);
    ...
    value: function createDonationUrlInternal(donation, network) {
      ...
      try {
        var url = new common.native.URL("".concat(donation.targetAddress, "/donation"), this.baseUrl);
...
var TezosPaymentsSigner = /*#__PURE__*/_createClass__default["default"](function TezosPaymentsSigner(signingType) {
...
var TezosPaymentsOptionsValidator = /*#__PURE__*/function () {
  function TezosPaymentsOptionsValidator() {
    _classCallCheck__default["default"](this, TezosPaymentsOptionsValidator);
  }

  _createClass__default["default"](TezosPaymentsOptionsValidator, [{
    key: "validateOptions",
    ...
    value: function validateNetwork(network) {
      ...
      if (_typeof__default["default"](network) !== 'object') return [TezosPaymentsOptionsValidator.errors.invalidNetwork];
    ...
    value: function validateSigningOptions(signingOptions) {
      if (_typeof__default["default"](signingOptions) !== 'object') return [TezosPaymentsOptionsValidator.errors.invalidSigningOption];
    ...
    value: function validateWalletSigningOptions(signingOptions) {
      if (_typeof__default["default"](signingOptions.wallet) !== 'object') return [TezosPaymentsOptionsValidator.errors.invalidWalletSigningOption];
    ...
    value: function validateDefaultPaymentParameters(defaultPaymentParameters) {
      ...
      if (_typeof__default["default"](defaultPaymentParameters) !== 'object') return [TezosPaymentsOptionsValidator.errors.invalidDefaultPaymentParameters];
