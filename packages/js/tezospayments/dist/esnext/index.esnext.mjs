import { guards, PaymentSerializer, DonationSerializer, PaymentUrlType, PaymentType, native, getEncodedPaymentUrlType, PaymentSignPayloadEncoder, tezosInfo, networkNameRegExp, networkIdRegExp, PaymentValidator, networks } from '@tezospayments/common';
...
class InvalidTezosPaymentsOptionsError extends TezosPaymentsError {
    constructor(messageOrValidationErrors) {
        super(guards.isReadonlyArray(messageOrValidationErrors)
...
class ApiSecretKeySigner extends TezosPaymentsSigner {
    apiSecretKey;
    paymentSignPayloadEncoder = new PaymentSignPayloadEncoder();
    inMemorySigner;
