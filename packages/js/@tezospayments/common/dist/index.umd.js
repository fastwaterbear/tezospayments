(function (global, factory) {
  ...
  const decode$1 = function (base64String) {
  ...
  const getAvatarText = function (value) {
    let maxLength = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
  ...
  const padEnd = function (string, maxLength) {
    let fillString = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ' ';
  ...
  */
  ...
  class Ed25519KeyGenerator {
    ...
    generate() {
      ...
      const keyPair = sodium__default["default"].crypto_sign_keypair('uint8array');
      const raw = {
