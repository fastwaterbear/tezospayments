...
class TezosPayments {
  ...
  validateServiceContractAddress(serviceContractAddress) {
    ...
    if (!common.tezosInfo.contractAddressPrefixes.some(prefix => serviceContractAddress.startsWith(prefix))) return [TezosPayments.optionsValidationErrors.serviceContractAddressIsNotContractAddress];
  }
