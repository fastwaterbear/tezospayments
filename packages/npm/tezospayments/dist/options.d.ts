...
declare type TezosPaymentsSigningOptions = TezosPaymentsApiSigningOptions | TezosPaymentsWalletSigningOptions | (TezosPaymentsApiSigningOptions & TezosPaymentsWalletSigningOptions) | ((payment: Payment, signingType: SigningType) => Promise<string>);
