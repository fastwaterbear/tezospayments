(function (global, factory) {
  ...
  _defineProperty$1(LegacyPaymentDeserializer, "serializedPaymentBase64Deserializer", new Base64Deserializer(legacySerializedPaymentFieldTypes));
  ...
  _defineProperty$1(LegacyDonationDeserializer, "serializedDonationBase64Deserializer", new Base64Deserializer(legacySerializedDonationFieldTypes));
  ...
  _defineProperty$1(Payment, "defaultLegacyDeserializer", new LegacyPaymentDeserializer());
  ...
  _defineProperty$1(Donation, "defaultLegacyDeserializer", new LegacyDonationDeserializer());
  ...
  class Base64PaymentUrlFactory extends PaymentUrlFactory {
    ...
    createUrl(isPayment, targetAddress, serializedPaymentOrDonationBase64, network) {
      const url = new index.URL(`${targetAddress}/${isPayment ? 'payment' : 'donation'}`, this.baseUrl);
