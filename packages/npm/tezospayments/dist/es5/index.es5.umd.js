(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taquito/signer')) :
  typeof define === 'function' && define.amd ? define(['exports', '@taquito/signer'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.tezosPayments = {}, global.taquitoSigner));
})(this, (function (exports, signer) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  function () {
    ...
    Parser.prototype.expand = function (ex) {
      ...
      if (((_a = this.opt) === null || _a === void 0 ? void 0 : _a.expandMacros) !== undefined ? (_b = this.opt) === null || _b === void 0 ? void 0 : _b.expandMacros : true) {
        ...
        if (ret !== ex) {
          ret[sourceReference] = _assign(_assign({}, ex[sourceReference] || {
            first: 0,
            last: 0
          }), {
            macro: ex
  ...
  function unpackComb(id, v) {
    ...
    return _assign(_assign({}, Array.isArray(vv) ? {
      prim: id
    } : vv), {
      args: [args[0], {
        prim: id,
  ...
  function writeExpr(expr, wr, tf) {
    ...
    if ("int" in e) {
      ...
      do {
        ...
        var _byte = val & (BigInt(1) << bits) - BigInt(1);
  ...
  var isOrData = function isOrData(e) {
    return "prim" in e && (e.prim === "Left" || e.prim === "Right");
  };

  var isOptionData = function isOptionData(e) {
    return "prim" in e && (e.prim === "Some" || e.prim === "None");
  };

  var getWriteTransformFunc = function getWriteTransformFunc(t) {
    if (isPairType(t)) {
      return function (d) {
        if (!isPairData(d)) {
  ...
  var isPushInstruction = function isPushInstruction(e) {
    return "prim" in e && e.prim === "PUSH";
  };

  var writePassThrough = function writePassThrough(e) {
  ...
  function functionTypeInternal(inst, stack, ctx) {
    ...
    function instructionAnn(num, opt) {
      var a = argAnn(instruction, _assign(_assign({}, opt), {
        emptyFields: num.f !== undefined && num.f > 1,
        emptyVar: num.v !== undefined && num.v > 1
      }));

      var assertNum = function assertNum(a, n, type) {
        if (a && a.length > (n || 0)) {
    ...
    function annotate(tt, a) {
      ...
      return _assign(_assign({}, rest), ann && ann.length !== 0 && {
        annots: ann
      });
    ...
    var varSuffix = function varSuffix(a, suffix) {
    ...
    var retStack = function (instruction) {
      ...
      switch (instruction.prim) {
        ...
        case "PUSH":
          assertTypeAnnotationsValid(instruction.args[0]);
          assertDataValidInternal(instruction.args[1], instruction.args[0], _assign(_assign({}, ctx), {
            contract: undefined
          }));
        ...
        case "LAMBDA":
          {
            assertTypeAnnotationsValid(instruction.args[0]);
            assertTypeAnnotationsValid(instruction.args[1]);
            var body = functionTypeInternal(instruction.args[2], [instruction.args[0]], _assign(_assign({}, ctx), {
              contract: undefined
            }));
  ...
  function assertContractValid(contract, ctx) {
    ...
    var arg = {
      "prim": "pair",
      args: [_assign(_assign({}, parameter), {
        annots: ["@parameter"]
      }), _assign(_assign({}, storage), {
        annots: ["@storage"]
      })]
    };
    var code = contractSection(contract, "code").args[0];
    var ret = functionTypeInternal(code, [arg], _assign(_assign({}, ctx), {
      contract: contract
    }));
  ...
  var TezosPaymentsError = /*#__PURE__*/function (_Error) {
    ...
    var _super = _createSuper(TezosPaymentsError);
  ...
  var InvalidTezosPaymentsOptionsError = /*#__PURE__*/function (_TezosPaymentsError) {
    ...
    var _super2 = _createSuper(InvalidTezosPaymentsOptionsError);
  ...
  var InvalidPaymentCreateParametersError = /*#__PURE__*/function (_TezosPaymentsError2) {
    ...
    var _super3 = _createSuper(InvalidPaymentCreateParametersError);
  ...
  var InvalidPaymentError = /*#__PURE__*/function (_TezosPaymentsError3) {
    ...
    var _super4 = _createSuper(InvalidPaymentError);
  ...
  var UnsupportedPaymentUrlTypeError = /*#__PURE__*/function (_TezosPaymentsError4) {
    ...
    var _super5 = _createSuper(UnsupportedPaymentUrlTypeError);
  ...
  var PaymentUrlError = /*#__PURE__*/function (_TezosPaymentsError5) {
    ...
    var _super6 = _createSuper(PaymentUrlError);
  ...
  var DonationUrlError = /*#__PURE__*/function (_TezosPaymentsError6) {
    ...
    var _super7 = _createSuper(DonationUrlError);
  ...
  var Base64PaymentUrlFactory = /*#__PURE__*/function (_PaymentUrlFactory) {
    ...
    var _super = _createSuper(Base64PaymentUrlFactory);
    ...
    function Base64PaymentUrlFactory() {
      ...
      _this = _super.call(this, exports.PaymentUrlType.Base64);

      _defineProperty$1(_assertThisInitialized(_this), "paymentSerializer", new PaymentSerializer());

      _defineProperty$1(_assertThisInitialized(_this), "donationSerializer", new DonationSerializer());
    ...
    _createClass(Base64PaymentUrlFactory, [{
      ...
      value: function createUrl(isPayment, targetAddress, serializedPaymentOrDonationBase64, network) {
        var url = new index.URL("".concat(targetAddress, "/").concat(isPayment ? 'payment' : 'donation'), this.baseUrl);
  ...
  _defineProperty$1(Base64PaymentUrlFactory, "baseUrl", constants.paymentAppBaseUrl);
  ...
  var ApiSecretKeySigner = /*#__PURE__*/function (_TezosPaymentsSigner) {
    ...
    var _super = _createSuper(ApiSecretKeySigner);
    ...
    function ApiSecretKeySigner(apiSecretKey) {
      ...
      _defineProperty$1(_assertThisInitialized(_this), "paymentSignPayloadEncoder", new PaymentSignPayloadEncoder());
    ...
    _createClass(ApiSecretKeySigner, [{
      key: "sign",
      value: function () {
        var _sign = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(payment) {
          var _signatures$;
  ...
  var WalletSigner = /*#__PURE__*/function (_TezosPaymentsSigner) {
    ...
    var _super = _createSuper(WalletSigner);
  ...
  var TezosPayments = /*#__PURE__*/function () {
    function TezosPayments(options) {
      ...
      _defineProperty$1(this, "paymentValidator", new PaymentValidator());

      _defineProperty$1(this, "paymentUrlFactories", new Map());
    ...
    _createClass(TezosPayments, [{
      key: "createPayment",
      value: function () {
        var _createPayment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(createParameters) {
      ...
      value: function () {
        var _getSignedPayment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(unsignedPayment) {
      ...
      value: function validateDefaultPaymentParameters(defaultPaymentParameters) {
        ...
        if ('urlType' in defaultPaymentParameters && defaultPaymentParameters.urlType !== exports.PaymentUrlType.Base64) return [TezosPayments.optionsValidationErrors.invalidUrlType];
      }
    }]);
  ...
  _defineProperty$1(TezosPayments, "defaultPaymentParameters", {
    network: networks.granadanet,
    urlType: exports.PaymentUrlType.Base64
  });

  _defineProperty$1(TezosPayments, "optionsValidationErrors", tezosPaymentsOptionsValidationErrors);
...
//# sourceMappingURL=index.es5.umd.js.map
