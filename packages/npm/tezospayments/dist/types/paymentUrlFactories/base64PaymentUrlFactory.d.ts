import { PaymentSerializer, CustomNetwork, Network, Payment, Donation, DonationSerializer } from '@tezospayments/common';
...
export declare class Base64PaymentUrlFactory extends PaymentUrlFactory {
    ...
    protected createUrl(isPayment: boolean, targetAddress: string, serializedPaymentOrDonationBase64: string, network: Network | CustomNetwork): string;
}
