...
class PaymentParserBase {
  ...
  parse(paymentBase64, nonIncludedFields) {
    try {
      ...
      if (paymentBase64) {
        const paymentString = buffer.Buffer.from(paymentBase64, 'base64').toString('utf8');
...
class PaymentParser extends PaymentParserBase {
  constructor(...args) {
    ...
    _defineProperty__default['default'](this, "_paymentFieldTypes", new Map().set('amount', 'string').set('data', 'object').set('asset', ['string', 'undefined', 'null']).set('successUrl', ['string', 'undefined', 'null']).set('cancelUrl', ['string', 'undefined', 'null']).set('created', 'number').set('expired', ['number', 'undefined', 'null']));
  }
...
class DonationParser extends PaymentParserBase {
  constructor(...args) {
    ...
    _defineProperty__default['default'](this, "_paymentFieldTypes", new Map().set('desiredAmount', ['string', 'undefined', 'null']).set('desiredAsset', ['string', 'undefined', 'null']).set('successUrl', ['string', 'undefined', 'null']).set('cancelUrl', ['string', 'undefined', 'null']));
  }
