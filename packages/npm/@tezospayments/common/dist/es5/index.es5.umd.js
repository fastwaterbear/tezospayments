(function (global, factory) {
    ...
    _createClass(PaymentParserBase, [{
      ...
      get: function get() {
        if (!this._minPaymentFieldsCount) {
          ...
          var _iterator = _createForOfIteratorHelper(this.paymentFieldTypes),
              _step;
      ...
      value: function validateRawPayment(rawPayment) {
        ...
        var _iterator2 = _createForOfIteratorHelper(this.paymentFieldTypes),
            _step2;
  ...
  var PaymentParser = /*#__PURE__*/function (_PaymentParserBase) {
    ...
    var _super = _createSuper(PaymentParser);
  ...
  var DonationParser = /*#__PURE__*/function (_PaymentParserBase) {
    ...
    var _super = _createSuper(DonationParser);
