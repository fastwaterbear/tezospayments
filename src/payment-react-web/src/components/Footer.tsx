...
export const Footer = () => {
  return <footer>
    ...
    <span className={cssClasses.warning}>
      ...
      the <ExternalLink href={config.tezos.officialSiteUrl}>Tezos network</ExternalLink>.
      ...
      Tezos Payments is just a UI <ExternalLink href={config.app.sourcesUrl}>(open-source)</ExternalLink> to
