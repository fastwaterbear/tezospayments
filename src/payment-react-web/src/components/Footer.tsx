...
export const Footer = () => {
  return <footer>
    <h6 className={cssClasses.label}>Powered by <a href={config.app.publicUrl} target="_blank" rel="noopener noreferrer">Tezos Payments</a></h6>

    <span className={cssClasses.warning}>
      All payments are made through smart contracts in
      the <a href={config.tezosOfficialSiteUrl} target="_blank" rel="noopener noreferrer">Tezos network</a>.
      ...
      Tezos Payments is just a UI <a href={config.app.sourcesUrl} target="_blank" rel="noopener noreferrer">(open-source)</a> to
